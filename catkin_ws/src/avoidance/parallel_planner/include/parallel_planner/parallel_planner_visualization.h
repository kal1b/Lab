#ifndef PARALLEL_PLANNER_VISUALIZATION_H
#define PARALLEL_PLANNER_VISUALIZATION_H

#include "parallel_planner/parallel_planner.h"
#include "parallel_planner/waypoint_generator.h"
...
class ParallelPlannerVisualization {
 public:
  /**
  * @brief      initializes all publishers used for Parallel planner visualization
  **/
  ...
  *              (non-smoothed)
  **/
  void visualizePlannerData(const ParallelPlanner& planner, const Eigen::Vector3f& newest_waypoint_position,
  ...
  **/
  ...
  /**
  * @brief       Visualization of the 2D compression of the Parallel pointcloud
...
#endif  // PARALLEL_PLANNER_VISUALIZATION_H
