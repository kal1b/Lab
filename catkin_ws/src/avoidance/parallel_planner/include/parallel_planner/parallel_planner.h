#ifndef PARALLEL_PLANNER_PARALLEL_PLANNER_H
#define PARALLEL_PLANNER_PARALLEL_PLANNER_H
...
#include <parallel_planner/ParallelPlannerNodeConfig.h>
...
class ParallelPlanner {
  ...
  **/
  void dynamicReconfigureSetParams(avoidance::ParallelPlannerNodeConfig& config, uint32_t level);
  ...
  **/
  ...
  /**
  * @brief     getter method of the Parallel planner algorithm
  * @param[in] output of a Parallel planner iteration
  **/
  ...
  **/
  ...
  /**
  * @brief     starts a iteration of the Parallel planner algorithm
  **/
  void runPlanner();
