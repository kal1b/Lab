...
#include "../include/parallel_planner/parallel_planner_nodelet.h"

using namespace avoidance;

TEST(ParallelPlannerNodeletTests, failsafe) {
  ros::Time::init();
  ParallelPlannerNodelet Node;
  ...
  avoidance::ParallelPlannerNodeConfig config = avoidance::ParallelPlannerNodeConfig::__getDefault__();
...
TEST(ParallelPlannerNodeletTests, mission_item_speed) {
  ros::Time::init();
  ParallelPlannerNodelet Node;
  Node.InitializeNodelet();
